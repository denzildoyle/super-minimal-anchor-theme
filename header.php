...
<html lang="en">
	<head>
		...
		<script>
		  ...
		  ga('create', 'UA-38539184-8', 'denzildoyle.me');
		  ga('send', 'pageview');
		...
		<div class="main-wrap">
			<header class="content wrap" >
				<div class="container">
					...
					<p class="read-time"> <span class="glyphicon glyphicon-book"></span> <?php echo ceil(count_words(article_markdown()) / 33); ?> Min Read</p>
